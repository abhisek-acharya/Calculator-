    ...
    public class Functions
    {
        ...
        public static void DrawChart_North(Graphics objGraphics, RectangleF chartRect, int Lagna_Sign, int[] Planet_Signs, double[] Planet_Degrees, double birthJulDay)
        {
            try
            {
                ...
                SolidBrush brushBkGnd = new SolidBrush(Color.White);// Color.FromArgb(251, 237, 119));
                ...
                /*
                    ...
                    * Chiron - Aries, Cancer and Sagittarius								
                    * Planet X - Aries, Taurus, Gemini, Virgo, Libra, Sagittarius, Aquarius and Pisces, Capricorn and Cancer .								
                ...
                if(Planet_Signs[12] == 1 || Planet_Signs[12] == 4 || Planet_Signs[12] == 9 ) //Chiron
                {
                    fontPlanetBrush[12] = new SolidBrush(Good);
                    GoodBad[12] = 1;
                }
                if( Planet_Signs[13] == 1 || Planet_Signs[13] == 2 || Planet_Signs[13] == 3 || Planet_Signs[13] == 4 || Planet_Signs[13] == 6 || Planet_Signs[13] == 7 || Planet_Signs[13] == 9 || Planet_Signs[13] == 10 || Planet_Signs[13] == 11 || Planet_Signs[13] == 12 ) //X
                {
                    fontPlanetBrush[13] = new SolidBrush(Good);
                    GoodBad[13] = 1;
                }
                if( Planet_Signs[14] == 3 || Planet_Signs[14] == 6 || Planet_Signs[14] == 1) //Y
                {
                    fontPlanetBrush[14] = new SolidBrush(Good);
                    GoodBad[14] = 1;
                }
                if( Planet_Signs[15] == 5 || Planet_Signs[15] == 7 || Planet_Signs[15] == 12) //Z
                {
                 ...
                 * Whenever X is placed in Leo or Scorpio, it has to be coloured in Red.
                 * Chiron should be mentioned in Red colour whenever it is in Capricorn, Libra and Gemini irrespective of which house it is in. 
                 * Planet Y should be mentioned in Red colour whenever it is in Sagittarius and Pisces irrespective of which house it is in. 
                 * Planet Z should be mentioned in Red colour whenever it is in Aquarius and Aries, irrespective of which house it is in.
                 * Uranus should be mentioned in Red colour whenever it is in Taurus and Leo irrespective of which house it is in. 
                 * Neptune should be mentioned in Red colour whenever it is in Virgo and Capricorn irrespective of which house it is in.
                 * Pluto should be mentioned in Red colour whenever it is in Taurus and Aquarius irrespective of which house it is in. 
                ...
                if (Planet_Signs[13] == 5 || Planet_Signs[13] == 8)
                {
                    fontPlanetBrush[13] = new SolidBrush(Bad);
                    GoodBad[13] = -1;
                }
                if (Planet_Signs[12] == 10 || Planet_Signs[12] == 3 || Planet_Signs[12] == 7)
                {
                    fontPlanetBrush[12] = new SolidBrush(Bad);
                    GoodBad[12] = -1;
                }
                if (Planet_Signs[14] == 9 || Planet_Signs[14] == 12)
                {
                    fontPlanetBrush[14] = new SolidBrush(Bad);
                    GoodBad[14] = -1;
                }
                if (Planet_Signs[15] == 11 || Planet_Signs[15] == 1)
                {
                    fontPlanetBrush[15] = new SolidBrush(Bad);
                    GoodBad[15] = -1;
                }
                if (Planet_Signs[9] == 2 || Planet_Signs[9] == 5)
                {
                    fontPlanetBrush[9] = new SolidBrush(Bad);
                    GoodBad[9] = -1;
                }
                if (Planet_Signs[10] == 6 || Planet_Signs[10] == 10)
                {
                    fontPlanetBrush[10] = new SolidBrush(Bad);
                    GoodBad[10] = -1;
                }
                if (Planet_Signs[11] == 2 || Planet_Signs[11] == 11)
                {
                 ...
                 * Mars 1st, 3rd, 6th, 7th 8th and 12th or Venus in 3rd, 6th, 7th 8th and 12th (Planets to be circled Red)
                ...
                if (House_Planet[2] == 1 || House_Planet[2] == 3 || House_Planet[2] == 6 || House_Planet[2] == 7 || House_Planet[2] == 8 || House_Planet[2] == 12)
                    RedCircle_eachLagna[2] = -1;
                if (House_Planet[5] == 3 || House_Planet[5] == 6 || House_Planet[5] == 7 || House_Planet[5] == 8 || House_Planet[5] == 12)
                    RedCircle_eachLagna[5] = -1;
...
//                    put ur ne pl, and asteroids in the outer_string
        ...
        public static void DrawChart_Round(Graphics objGraphics, RectangleF chartRect, int Lagna_Sign, int[] Planet_Signs, double[] Planet_Degrees, double birthJulDay)
        {
            try
            {
                ...
                Font houseFont = new Font("Times New Roman", 9);
                Font planetFont = new Font("Times New Roman", 10, FontStyle.Bold);
