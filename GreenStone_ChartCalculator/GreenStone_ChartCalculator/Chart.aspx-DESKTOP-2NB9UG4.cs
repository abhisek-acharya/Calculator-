        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                try
                {
                    ...
                    //////////////////////////////////////
                    string str, name;
                    name = string.Format("{0}  {1}/{2:00}/{3}  {4:00}:{5:00}:{6:00}  {7}, {8}", PreviousPage.Name, Month_Name[Birth_Month - 1], Birth_Day, Birth_Year, Birth_Hour, Birth_Minute, Birth_Second, City, PreviousPage.Country);
                    //Literal1.Text = name;

                    str = string.Format("<img alt =\"horoscope\" src=\"DrawChart.aspx?Width=650&Height=820&" +
                      ...
                      "birthTimeZone={25}&birthDST={26}&birthJulDay={27}&Name={28}\">",
