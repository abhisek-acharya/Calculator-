...
namespace GreenStone_ChartCalculator
{
    ...
    public class swedll
    {
        ...
        public static void Calculate_Planets(string Path, double tjd_ut, double dLatitude, double dLongitude, double[] planet_deg, out double lagna_deg, int[] planet_ret)
        {
            ...
            //Srishti: 2342210.84362268 is 27/8/1700 , Between this date and Aug 8 1706 ( 2344382.8436226854 ) I am making the Pluto stay at 1 degree Leo.
            if (tjd_ut >= 2342210.500000 && tjd_ut <= 2344382.500000)
                planet_deg[11] = 121;
            ...
            //GS: On 1st June 1948 Pluto enters Leo. The end date is 2nd Aug 1969.
            //Srishti: 2432703.500000 From 1st June 1948 to Aug 5th 1954 (2434959.500000)  when Pluto enters into Leo, pls make it stay at one degrees. 
            if (tjd_ut >= 2432703.500000 && tjd_ut <= 2434959.500000)
                planet_deg[11] = 121;
            //During entire 1968 pls let it hover on 28 degrees
            if (tjd_ut >= 2439856.500000 && tjd_ut <= 2440221.500000)
                planet_deg[11] = 148;
            //From Jan 1969 to 2nd Aug 1969, pls make it hover around 29 degrees Leo. Also there should be no retrogression into Virgo during this time
            if (tjd_ut > 2440221.500000 && tjd_ut <= 2440435.500000)
                planet_deg[11] = 149;

            //GS: On 27th Nov 1989 Pluto enters Scorpio. The end date is the same as in original software.
            //Srishti: 2447857.75 is 27/11/1989 , Between this date and 1993/Nov/3 ( 2449294.75 ) I am making the Pluto stay at 1 degree Scorpio.
            ...
            //Srishti:  2444147.500000 is Oct/1/1979 , Between this date and Oct/28/1980 ( 2444540.75 ) I am making the Uranus stay at 1 degree Scorpio.
            if (tjd_ut >= 2444147.500000 && tjd_ut <= 2444540.75)
                planet_deg[9] = 211;

            //GS: Uranus needs to be in Scorpio during Feb 1987 to 30th Sep 1987 . (currently it is retrograde in Sagittarius)
            //From Feb 1 1987 (2446827.000000) to 30th Sep 1987  (2447068.500000) Uranus needs to be in 29 degree Scorpio
            if (tjd_ut >= 2446827.000000 && tjd_ut <= 2447068.500000)
                planet_deg[9] = 239;
