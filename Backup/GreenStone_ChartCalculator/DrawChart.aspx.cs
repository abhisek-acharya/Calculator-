    ...
    public partial class DrawChart : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                height = Width / 2 - 30;
                chartRect = new RectangleF(x1, y1, width, height);
                Functions.DrawChart_North(objGraphics, chartRect, Lg_Sign, Planet_Signs, Planet_Degrees);

                /***************************RoundChart**********************************************/
                x1 = Width / 2 + 10;
                chartRect = new RectangleF(x1, y1, width, height);
                Functions.DrawChart_Round(objGraphics, chartRect, Lg_Sign, Planet_Signs, Planet_Degrees);
                ...
                height = Width / 2 - 30;
                chartRect = new RectangleF(x1, y1, width, height);
                Functions.DrawChart_South(objGraphics, chartRect, Lg_Sign, Planet_Signs, Planet_Degrees);
